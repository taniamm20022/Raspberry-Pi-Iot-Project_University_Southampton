...
{
  public class AuthenticationAttributeSensors : ActionFilterAttribute
  {
    private readonly TokenContainer tokenContainer;

    public AuthenticationAttributeSensors()
    {
    ...
    public override void OnActionExecuting(ActionExecutingContext filterContext)
    {
      ...
      {
        var controller = (SensorsController)filterContext.Controller;
